...
/*
  ...
  Amy and Brittani were born in the same year. If they were, console.log 'Amy & Brittani 
...
/*
  ...
  one should wear a jacket and carry an umbrella. Come up with your own clothing suggestions based on those temperature 
...
if (temperature >= 80 && rain){
  ...
  console.log("Bring a sweatshirt!");
} else if (temperature <= 60 && !rain){
